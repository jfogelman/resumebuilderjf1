...
/*            var query = from b in db.Usertables
            ...
            */
            ...
            IQueryable<Usertable> uts = from b in db.Usertables
                                       orderby b.Username
                                       select b;
            foreach (Usertable ut in uts)
            {
               // MembershipUser mu = new MembershipUser();
               // users.Add(ut.Username);
            }

//            var a = db.Usertables.ToList();


            //query.ToArray<Usertable>;
//            foreach (Usertable

  //          MembershipUserCollection users = new MembershipUserCollection();

            //users.Add(query.ToList<Usertable>());
